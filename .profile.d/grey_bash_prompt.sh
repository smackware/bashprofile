...
prompt_cmd() {
  ...
  let BAR_LENGTH=${COLUMNS}-$PROMPT_LENGTH-$DIRECTORY_LENGTH-1-$LAST_RET_LENGTH-$GIT_BRANCH_LEN-$KNIFE_ENV_LEN
  ...
  PS1="$DIRECTORY$BAR$PROMPT${KNIFE_ENV}$GIT_BRANCH${BAR_COLOR}$PADDING$DEFAULT_COLOR${NONE}\r\n$PROMPT_COLOR\$ ${NONE}"
  _=$LAST_ARG
}
